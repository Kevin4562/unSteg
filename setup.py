...
setup(
  ...
  packages=['Honors-Project'],   # Chose the same as "name"
  ...
  download_url='https://github.com/Kevin4562/Digital-Forensics-Honors-Project/archive/v_05.tar.gz',    # I explain this later on
